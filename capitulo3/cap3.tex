...
O nó \textit{root} é o responsável por disseminar o tempo global pela rede, porém há redes em que os nós não estão ao alcance da faixa de cobertura do seu sinal, o FTSP tem o recurso de rede multi-saltos, ele constrói uma estrutura \textit{ad hoc}, onde, os nós diretamente sincronizados com o \textit{root}, ficam atualizando os nós subsequentes com sua informação de tempo global.
