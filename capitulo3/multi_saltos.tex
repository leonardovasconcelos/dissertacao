...
\subfigure[fig:reeleicao1][Com a chegada de um novo nó com ID menor, esse nó não se declara \textit{root} e começa a enviar suas mensagens imediatamente, ele aguarda até preencher sua tabela e estar atualizado.]
        {\includegraphics[width=6cm]{./figuras/releicao_root1.eps}}
~
\subfigure[fig:reeleicao2][Após algumas rodadas de sincronização, o nó está atualizado e então passa a enviar suas mensagens de sincronização com sua referência de tempo. Os outros nós atualizam seu \textit{rootID}.]
        {\includegraphics[width=6cm]{./figuras/releicao_root2.eps}}
