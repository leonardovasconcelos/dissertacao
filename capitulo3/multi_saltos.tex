...
A Figura \ref{figure1} mostra o pseudocódigo do processo de recebimento de uma mensagem de sincronização. As linhas 2 e 3 comparam o \texttt{rootID} contido na mensagem com o valor \texttt{rootID} local.
