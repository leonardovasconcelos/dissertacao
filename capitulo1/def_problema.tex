...
O FTSP é o estado da arte dos protocolos de sincronização \textit{multi-hop} \cite{Sommer:IPSN09}, um dos mais populares \cite{lenzen2015pulsesync,holtkamp2013,shannon2012dynamic} e vem disponível por padrão no sistema operacional TinyOS. Uma de suas principais características é o uso de timestamp na camada MAC. Se uma plataforma particular não suportar a mudança do conteúdo da mensagem depois de ocorrido o evento de sincronização, então o FTSP não pode ser implementado nessa plataforma. Assim o protocolo é fortemente dependente de recursos específicos do \textit{chip} de rádio. 
