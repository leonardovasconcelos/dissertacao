...
Os \textit{motes} são fabricados com materiais de baixo custo, como por exemplo o cristal de quartzo, o que os torna mais imprecisos. A Figura \ref{fig:overhead} apresenta o \textit{tradeoff} entre o  preço e a qualidade, o preço de produção determina a precisão do relógio, assim quanto menos preciso o relógio é mais compensação será necessária para corrigir seu tempo, compensação gera \textit{overhead} de comunicação que é gasto no uso de comunicação/energia.
