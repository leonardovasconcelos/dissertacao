...
\begin{itemize}
 ...
 \item Alinhamento de Byte: Diferentes tipos de alinhamento entre o transmissor e receptor, causam a necessidade de reordenar os bytes.
\end{itemize}


% Nem todos os componentes são possíveis de se contabilizar, 
% 
% Ainda dentro dessa classificação, temos derivar
...
Alguns dos componentes de atraso são de origem não determinístico, outros podem ser calculados e estimados, a \ref{tab:decomp} sintetiza o tamanho e classificação dos componentes já listados.
