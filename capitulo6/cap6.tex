...
Neste capítulo nos descrevemos nossos experimentos a respeito da precisão do FTSP+.
Nós implementamos o FTSP+ sobre TinyOS 2.1.2 \cite{levis2004tinyos} e executamos os testes em \textit{motes} Micaz \cite{Micaz}.
...
\begin{figure}[htb!]
	...
	\caption{Histogramda e P.D.F. dos tempos de correção.}
...
\end{figure}
 ...
 \centering
 \begin{tabular}{c|c|c}
 		& \multirow{2}{*}{\textbf{mean ($\mu{s}$)}}	& \multirow{2}{*}{\textbf{std. deviation}} \\
		&&\\
 $\mathbf{processing~time}$ 	&  $0.87 \pm 0.0095$ 	& $0.33$\\
 $\mathbf{\delta}$  	&  $0.88 \pm 0.0093$ 	& $0.33$\\
 $\mathbf{correction~time}$ 	& $9.01 \pm 0.093$	& $3.32$\\
 $\mathbf{medium~access}$ 	& $8.13 \pm 0.093$	& $3.31$\\
...
\textbf{Delay in jiffys} 			& 0 		& 1 			& 2 & 3 & 4 & 5 \\
\textbf{Frequency} 	& 606 	& 4271  & 0 & 1 & 1 & 1 \\
\end{tabular}
...
\begin{tabular}{l|c|c|c|c|c|c}
\textbf{Delay in jiffys} 			& 0 		& 1 			& 2 & 3 & 4 & 5 \\
\textbf{Frequency} 	& 581 	& 4297  & 0 & 0 & 1 & 1 \\
\end{tabular}
...
Relembrando da Seção \ref{seq:mod} que eles são o tempo de processamento da interrupção do rádio no emissor e no receptor.
